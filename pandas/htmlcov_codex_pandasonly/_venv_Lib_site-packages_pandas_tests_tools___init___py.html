...
<head>
    ...
    <title>Coverage for .venv\Lib\site-packages\pandas\tests\tools\__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.venv\Lib\site-packages\pandas\tests\tools\__init__.py</b> :
