...
$TFM          = "net11.0"
$OUT          = "$PSScriptRoot\reports\human"
...
$TEST_FILES   = @(
    "$PSScriptRoot\tests\Humanizer.Tests\StringHumanizeTests.cs",
    "$PSScriptRoot\tests\Humanizer.Tests\NumberToWordsTests.cs"
)

Write-Host "============================================================="
Write-Host " HUMAN tests: StringHumanizeTests, NumberToWordsTests"
Write-Host "============================================================="
...
dotnet test $TESTS_PROJ --framework $TFM --no-build -c Release `
    --filter-class "StringHumanizeTests" `
    --filter-class "NumberToWordsTests" `
    --coverage `
...
<title>Static Analysis - Human</title>
...
<h1>Static Analysis (dotnet format) - Human Tests</h1>
...
@"
<!DOCTYPE html><html><head><meta charset='utf-8'>
<title>Assertion Density - Human</title>
...
<h1>Assertion Density - Human Tests</h1>
<table>
