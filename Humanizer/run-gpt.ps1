...
$TEST_FILES   = @(
    "$PSScriptRoot\tests\Humanizer.Tests\StringHumanizeGptTests.cs",
    "$PSScriptRoot\tests\Humanizer.Tests\NumberToWordsGptTests.cs"
)

Write-Host "============================================================="
Write-Host " GPT tests: StringHumanizeGptTests, NumberToWordsGptTests"
Write-Host "============================================================="
...
dotnet test $TESTS_PROJ --framework $TFM --no-build -c Release `
    --filter-class "Humanizer.Tests.StringHumanizeGptTests" `
    --filter-class "Humanizer.Tests.NumberToWordsGptTests" `
    --coverage `
...
<title>Static Analysis - GPT</title>
...
<h1>Static Analysis (dotnet format) - GPT Tests</h1>
...
@"
<!DOCTYPE html><html><head><meta charset='utf-8'>
<title>Assertion Density - GPT</title>
...
<h1>Assertion Density - GPT Tests</h1>
<table>
